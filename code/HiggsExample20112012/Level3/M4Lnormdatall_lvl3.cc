...
void M4Lnormdatall_lvl3() {
  ...
  // H -> ZZ -> 4mu
  f2 = TFile::Open((outDir + inFileHZZ12).c_str());
  std::cout <<"opening file " << (outDir + inFileHZZ12).c_str() << std::endl;
  ...
  f3 = TFile::Open((outDir + inFileUser).c_str());
  std::cout << "opening file " << (outDir + inFileUser).c_str() << std::endl;
